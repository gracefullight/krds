// filepath: kakaotalk-channel.tsx
import type { IconProps } from "#/types";

export function KakaotalkChannel({
  size = 24,
  color = "currentColor",
  title,
  ...props
