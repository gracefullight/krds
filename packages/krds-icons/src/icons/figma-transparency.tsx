...
export function FigmaTransparency({
  ...
  return (
    ...
    >
      <title>{title}</title>
      <path d="M3 4C3 3.44772 3.44772 3 4 3H6.6V6.6H3V4Z" fill={color} />
      <path d="M3 10.2002H6.6V13.8002H3V10.2002Z" fill={color} />
      <path
      ...
      <path
        ...
        fill={color}
      />
      <path d="M10.1992 3H13.7992V6.6H10.1992V3Z" fill={color} />
      <path
        d="M13.7992 17.3999H10.1992V20.9999H13.7992V17.3999Z"
        fill={color}
      />
      <path d="M6.60156 6.6001H10.2016V10.2001H6.60156V6.6001Z" fill={color} />
      <path d="M17.4008 6.6001H13.8008V10.2001H17.4008V6.6001Z" fill={color} />
    </svg>
  );
}
